            ...
            <main className="flex-1 overflow-y-auto px-4 py-8 md:px-10 md:py-12">
                <header className="flex flex-col md:flex-row md:items-center justify-between mb-8 md:mb-12 gap-6 md:gap-0">
                    <div className="text-center md:text-left">
                        ...
                        <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Bad Reviews</h1>
                        <p className="text-muted-foreground mt-2 text-sm md:text-base">Feedback items flagged as poor or negative for this project.</p>
                    </div>
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        <div className="relative flex-1 md:flex-none">
                            ...
                            <input
                                ...
                                className="bg-accent/20 border-transparent rounded-xl pl-10 pr-4 py-2 text-sm focus:bg-background focus:border-primary transition-all outline-none w-full md:w-64"
                            />
                        </div>
                        ...
                        <table className="w-full text-left text-sm min-w-[700px]">
                            <thead className="text-muted-foreground uppercase text-[10px] font-bold tracking-wider">
                                <tr className="border-b bg-background/50">
                                    <th className="px-4 md:px-6 py-4">Review Content</th>
                            ...
                            <tbody className="divide-y divide-border/50">
                                {badReviews.map((review: any, i: number) => (
                                    ...
                                    >
                                        <td className="px-4 md:px-6 py-5 max-w-xl">
