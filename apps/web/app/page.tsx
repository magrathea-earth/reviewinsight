                    ...
                    <div className="text-center space-y-8 mb-20 relative px-4">
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className="absolute top-[-15%] left-[-5%] md:left-[0%] w-56 h-56 md:w-[35rem] md:h-[35rem] opacity-30 mix-blend-multiply blur-0 filter drop-shadow-2xl contrast-110 brightness-110"
                            >
                            ...
                            <motion.div
                                ...
                                className="absolute top-[5%] right-[-5%] md:right-[0%] w-56 h-56 md:w-[35rem] md:h-[35rem] opacity-30 mix-blend-multiply blur-0 filter drop-shadow-2xl contrast-110 brightness-110"
                            >
